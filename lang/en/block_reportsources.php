...
/**
 * Strings for block_reportsources.
 *
...
$string['reportsources:addinstance'] = 'Add a new Report sources block';
$string['reportsources:myaddinstance'] = 'Add a new Report sources block to the Dashboard';
